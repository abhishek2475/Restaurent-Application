          ...
          {  
            if($id != '' && $date != '' && $time != '' && $slot != '')
            {
                ...
                if(mysqli_num_rows($q) > 0)
                {
                     ...
                     $cmd = mysqli_query($con,"select * from banquet_booking_user where date ='$date' AND status = 1 AND time = '$time' AND end_time = '$endtime'");
                    ...
                    if($cmd)
                    {
                        ...
                        {
                            $cmd1 = mysqli_query($con,"select * from banquet_booking_user where date ='$date' AND status = 1 AND time > '$time' AND end_time > '$time' AND time < '$endtime' AND end_time < '$endtime'");
                            ...
                            if($cmd1)
                            {
                                ...
                                else
                                {
                                    ...
                                    $cmd2 = mysqli_query($con,"select * from banquet_booking_user where date ='$date' AND status = 1 AND ((time >= '$time' AND time <= '$endtime') OR (end_time >= '$endtime' AND end_time <= '$endtime'))");
