	...
	<div class="container">
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="takeaway.php"><i class="fa fa-utensils icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
					<a href="takeaway-1.php"><i class="fa fa-cart-plus icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
			    <a href="takeaway-2.php"><i class="fas fa-user-circle icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
    ...
    <section class="second-sect">
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #ff006f">Order Confirmation</h1>
        						...
        						<form id="contactForm" method="post" action="#">
        							<div class="row">
        								...
        								<div class="col-md-12">
        									...
        									<div class="form-group">
                                                <input type="tel" placeholder="8574572362" id="mobile" class="form-control" name="mobile_no" required data-error="Please Enter Mobile No">
        										<div class="help-block with-errors"></div>
        									</div>
                                        </div>
        								<div class="col-md-12">
		...
		<?php
		    function email($tid , $mail)
			{
                ...
                $to = $mail;
                $subject = 'Takeaway - Mainstreet Banquet and Catering Service';
                ...
                while($r = mysqli_fetch_array($query)){
                    ...
                    <html lang="en">
                      <head>
                        <meta charset="UTF-8" />
                        <title>Food Order Details : Mainstreet Banquet Service</title>
                      </head>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        >
                                                          <span
                                                            style="font-weight: 600; color: #000000"
                                                            >Mainstreet Banquet and Catering Service</span
                                                          ><br />
                                                          Mainstreet Banquet Service, Dharm Nagar 2, Sabarmati, Ahmedabad
                    
                                                          <br />
                                                          +91 8574572362, +91   the
                                                          <br />
                                                            <a href="mailto:maniy2104@gmail.com" target="_blank"><span
                                                              style="font-weight: 500; color: #9095a2; text-decoration: none;"
                                                              >maniy2104@gmail.com </span></a>
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                              ...
                                              <tr>
                                                ...
                                                >
                                                  ...
                                                  <a
                                                    ...
                                                    href="mailto:maniy2104@gmail.com"
            ...
            $to = $mail;
            $subject = "Takeaway Confirmation - Mainstreet Banquet and Catering Service";
