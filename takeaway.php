	...
	<div class="container">
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="takwaway.php"><i class="fa fa-utensils icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #ff006f">Choose the Food Category</h1>
                ...
                <div class="products wow fadeInRight">
				    ...
				    ?>
		                    <div class="item" style="border-radius:10px; border:1px solid #ff006f;">
		                        ...
		                        <div class="cntBx">
		                            <div class="item-title" style="color : #ff006f;"><?php echo $r['name']; ?></div>
