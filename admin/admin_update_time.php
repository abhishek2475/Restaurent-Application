...
<?php
    ...
    function email( $id){
            require 'db.php';     
			$subject = "Banquet Booking Date & Time Change - Mainstreet Banquet and Catering Service";
    ...
    <body style="background-color: #f0f0f1; font-family: "Avenir Next", "Avenir", open sans, Helvetica; margin: 0; padding: 0;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="margin: 0;" width="100%">
            ...
            $subject = 'Banquet Date & Time Change - Mainstreet Banquet and Catering Service';
