                    ...
                    <td align="center" style="margin: 0; text-align: center; vertical-align: top;">
                        <table cellpadding="0" cellspacing="0" class="content-wrapper" style="margin: 0; padding: 0px 45px; font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica';font-size: 10px;line-height: 1.6;color: #9fa0a4; text-align: center;" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica';">Mainstreet Banquet Service, Dharm Nagar 2, Sabarmati, Ahmedabad</td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>
                                </tr>

                                <tr>
                                    <a href="tel:+918469000683" target="_blank"><td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica'; color:#ff006f;">Any Queries? Ring your phone to : <br>+91 8574572362, +91   </a></td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>


                                </tr>
                                <tr>
                                    <a href="https://yajmanrestaurant.com" target="_blank"><td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica'; color:#ff006f;">Visit our Website : yajmanrestaurant.com</a></td>
                                </tr>
                                <tr height="15" style="height: 15px">
                                </tr>
