	...
	<div class="container">
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="t1.php"><i class="fa fa-shopping-cart icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
					<a href="t2.php"><i class="fa fa-calendar-alt icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
