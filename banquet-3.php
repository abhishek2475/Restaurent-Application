<?php
	session_start();
	 if (date_default_timezone_set('Asia/Kolkata') === false) {
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="banquet.php"><i class="fa fa-shopping-cart icon1" style="color: #ff006f;"></i> </a>
			    <a href="banquet-1.php"><i class="fa fa-calendar-alt icon1" style="color: #ff006f;"></i> </a>
			    <a href="banquet-2.php"><i class="fas fa-user-circle icon1" style="color: #ff006f;"></i> </a>
    	</div>
		</div>
		</div>
	</div>
  ...
  <!-- Products Section -->
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #ff006f">User Details</h1>
    ...
    <form action="payment.php" class="payment">
        <!-- <button class="btn btn-lg btn-circle btn-outline-new-white" >Proceed To Payment</button> -->
        <a href="http://localhost/New%20folder/payment.php?" class="btn btn-lg btn-circle btn-outline-new-white">Proceed to Payment<a>
        <br><br>
    </form>
</div>
...
<?php 
    ...
    function email($email , $bbid, $menu){
            require 'db.php';            
            $to = $email;
			$subject = "Banquet Booking Confirmation - Mainstreet Banquet and Catering Service";
    ...
    <body style="background-color: #f0f0f1; font-family: "Avenir Next", "Avenir", open sans, Helvetica; margin: 0; padding: 0;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="margin: 0;" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica";">Sent with
                                        Care from Mainstreet Banquet Service</td>
                                </tr>
                                <tr>
                                    <td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica";">Mainstreet Banquet Service, Dharm Nagar 2, Sabarmati, Ahmedabad</td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>
                                </tr>

                                <tr>
                                    <a href="tel:+918469000683" target="_blank"><td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica"; color:#ff006f;">Any Queries? Ring your phone to : <br>+91 8574572362, +91   </a></td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>


                                </tr>
                                <tr>
                                    <a href="https://yajmanrestaurant.com" target="_blank"><td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica"; color:#ff006f;">Visit our Website : yajmanrestaurant.com</a></td>
                                </tr>
                                <tr height="15" style="height: 15px">
                                </tr>
			...
			$headers .= 'Cc: <maniy2104@gmail.com>' . "\r\n";
