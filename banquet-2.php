	...
	<div class="container">
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="banquet-1.php"><i class="fa fa-calendar-alt icon1" style="color: #ff006f; border: 2px solid #ff006f"></i></a>
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #ff006f">Slot Booking</h1>
