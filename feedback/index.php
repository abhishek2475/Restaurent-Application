...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Feedback Form - Mainstreet Banquet Service and Banquet</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2 style="color:#ff006f">Your Feedback Is Valuable To Us</h2>
				...
				<div class="col-lg-12">
					<form id="contactForm" method="post" action="#">
						<div class="row">
							...
							<div class="col-md-12 p-2">
								<div class="form-group">
									<span class="field-title" style="font-size:26px"> Your Review for Mainstreet Banquet and Catering Service</span>
	...
	<footer class="footer-area bg-f">
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">Rights Reserved. &copy; 2020 <a href="./index.html">&nbsp;Mainstreet Banquet and Catering Service</a> <br>    </p>
					</div>
				</div>
			</div>
		</div>
